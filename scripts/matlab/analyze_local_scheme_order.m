...
error_4_coarse = error_4(1:16:end,1:16:end);
error_5_coarse = error_5(1:32:end,1:32:end);
error_6_coarse = error_6(1:64:end,1:64:end);
error_7_coarse = error_7(1:128:end,1:128:end);
...
error_0_norm_p = calculate_two_norm_point(error_0_coarse, 4, 9);
error_1_norm_p = calculate_two_norm_point(error_1_coarse, 4, 9);
error_2_norm_p = calculate_two_norm_point(error_2_coarse, 4, 9);
error_3_norm_p = calculate_two_norm_point(error_3_coarse, 4, 9);
error_4_norm_p = calculate_two_norm_point(error_4_coarse, 4, 9);
error_5_norm_p = calculate_two_norm_point(error_5_coarse, 4, 9);
error_6_norm_p = calculate_two_norm_point(error_6_coarse, 4, 9);
error_7_norm_p = calculate_two_norm_point(error_7_coarse, 4, 9);
...
first_order = 0.01*h.^(1.0);
second_order = 0.1*h.^(2.0);
...
ylabel('$|\!|\mathrm{T-T_{ex}}|\!|_2$', 'interpreter', 'latex', 'FontSize', 30);

% Create legend
legend1 = legend('IBM', 'Improved IBM', '1st order','2nd order', '3rd order', '4th order', 'FontSize', 30);
